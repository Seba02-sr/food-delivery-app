...
public abstract class ItemMenuDto {
     ...
     * public ItemMenuDto(String nombre, String descripcion, String precioText,
     * String categoriaText, Integer idVendedor) {
     * this.nombre = nombre;
     ...
     * public ItemMenuDto(String idText, String nombre, String descripcion, String
