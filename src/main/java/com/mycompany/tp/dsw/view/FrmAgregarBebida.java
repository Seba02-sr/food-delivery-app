...
public class FrmAgregarBebida extends javax.swing.JFrame {
    ...
    public FrmAgregarBebida(String nombre, String descripcion, String precio, String categoria, Integer idVendedor,
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnGuardarActionPerformed
        ...
        System.out.println("Nombre2: " + nombre + ", Descripcion2: " + descripcion + ", Precio2: " + precio
                + ", Categoria2: " + categoria + ", Volumen: " + volumen);

        BebidaDto bebidaDto = new BebidaDto(nombre, descripcion, precio, categoria, vendedor, graduacionAlcoholica,
                tamano, volumen);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAgregarBebida("nombre", "descripcion", "precio", "categoria", 1,
