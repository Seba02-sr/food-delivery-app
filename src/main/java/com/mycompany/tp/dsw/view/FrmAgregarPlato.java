...
public class FrmAgregarPlato extends javax.swing.JFrame {
    ...
    private final String nombre, descripcion, precio, categoria;
    private final Integer idVendedor;
    private FrmItemMenu itemMenuForm;

    public FrmAgregarPlato(String nombre, String descripcion, String precio, String categoria, Integer idVendedor,
            FrmItemMenu itemMenuForm) {
        initComponents();
        this.nombre = nombre;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Vendedor vendedor = vendedorDao.buscarVendedorPorId(idVendedor);
        ...
        PlatoDto platoDto = new PlatoDto(nombre, descripcion, precio, categoria, vendedor, calorias, aptoCeliaco,
        ...
        System.out.println("Nombre2: " + nombre + ", Descripcion2: " + descripcion + ", Precio2: " + precio
                + ", Categoria2: " + categoria + ", Calorias:" +
                platoDto.getCalorias() + ", Peso: " + platoDto.getPeso() +
                ", Aptos C,Veget,Veg:" + platoDto.getAptoCeliaco() + platoDto.getAptoVegetariano()
                + platoDto.getAptoVegano());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAgregarPlato("nombre", "descripcion", "precio", "categoria", 1,
