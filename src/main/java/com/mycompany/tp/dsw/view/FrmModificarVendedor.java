...
public class FrmModificarVendedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, 150, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmModificarVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
