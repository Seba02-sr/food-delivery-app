...
public class FrmModificarVendedor extends javax.swing.JFrame {
    ...
    /**
     * Constructor para cuando se selecciona una fila de vendedor
     * 
     * @param dao
     * @param id
     * @param nombre
    ...
    private void rellenarCampos(VendedorDto vendedorDto, String fechaRegistro) {
        txtID.setEnabled(false);
        txtID.setText(vendedorDto.getIdText());
        txtNombre.setText(vendedorDto.getNombre());
        txtDireccion.setText(vendedorDto.getDireccion());
        txtLatitud.setText(vendedorDto.getLatitud());
        txtLongitud.setText(vendedorDto.getLongitud());
