...
public class JplVendedor extends javax.swing.JPanel {
    ...
    /**
     * Configura un menú contextual (popup) para la tabla `tbVendedorDatos`.
     * Este menú permite realizar diversas acciones relacionadas con los datos de un
     * vendedor.
     * 
     * Acciones incluidas en el menú:
     * - Cargar datos.
     * - Ver detalles del vendedor.
     * - Ver pedidos asociados al vendedor.
     * - Ver productos relacionados con el vendedor.
     */
    public void poputTable() {
        ...
        // Agrega "Ver Productos"
        jPopupMenu.add(jmiVerProductos);

        // Agregar el menu contextual a la tabla
